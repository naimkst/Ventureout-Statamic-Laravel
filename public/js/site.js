...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return {
    ...
    overflowClass: function overflowClass() {
...
/***/ "./resources/js/components/hero-slider.js":
/*!************************************************!*\
  !*** ./resources/js/components/hero-slider.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var appendChildAwaitLayout = function appendChildAwaitLayout(parent, element) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (_ref) {
  var _ref$speed = _ref.speed,
      ...
      _ref$spaceX = _ref.spaceX,
      spaceX = _ref$spaceX === void 0 ? 0 : _ref$spaceX,
      _ref$dynamicWidthElem = _ref.dynamicWidthElements,
      dynamicWidthElements = _ref$dynamicWidthElem === void 0 ? false : _ref$dynamicWidthElem;
  return {
    ...
    init: function init() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var images, originalWidth;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!_this2.dynamicWidthElements) {
                  _context.next = 5;
                  break;
                }

                images = _this2.$el.querySelectorAll('img'); // If there are any images, make sure they are loaded before
                ...
                _context.next = 5;
                return Promise.all(Array.from(images).map(function (image) {
                  return new Promise(function (resolve, _) {
                    if (image.complete) {
                      resolve();
                    } else {
              ...
              case 5:
                ...
                _this2.originalElement = _this2.$el.cloneNode(true);
                originalWidth = _this2.$el.scrollWidth + spaceX * 4; // Required for the marquee scroll animation to loop smoothly without jumping

                _this2.$el.style.setProperty('--marquee-width', originalWidth + 'px');

                _this2.$el.style.setProperty('--marquee-time', 1 / speed * originalWidth / 100 + 's');

                _this2.resize(); // Make sure the resize function can only be called once every 100ms
                // Not strictly necessary but stops lag when resizing window a bit


                window.addEventListener('resize', debounce(_this2.resize.bind(_this2), 100));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _this3.$el.innerHTML = _this3.originalElement.innerHTML; // Keep cloning elements until marquee starts to overflow

                i = 0;

              case 2:
                if (!(_this3.$el.scrollWidth <= _this3.$el.clientWidth)) {
                  _context2.next = 13;
                  break;
                }

                if (!_this3.dynamicWidthElements) {
                  _context2.next = 8;
                  break;
                }

                _context2.next = 6;
                return appendChildAwaitLayout(_this3.$el, _this3.originalElement.children[i].cloneNode(true));
              ...
              case 8:
                _this3.$el.appendChild(_this3.originalElement.children[i].cloneNode(true));

              case 9:
                i += 1;
                i = i % _this3.originalElement.childElementCount;
                _context2.next = 2;
                break;
              ...
              case 13:
                ...
                while (j < _this3.originalElement.childElementCount) {
                  _this3.$el.appendChild(_this3.originalElement.children[i].cloneNode(true));
...
/***/ "./resources/js/components/service-slider.js":
/*!***************************************************!*\
  !*** ./resources/js/components/service-slider.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return {
    ...
    init: function init() {
      ...
      this.$nextTick(function () {
        return _this.select(_this.$id('tab', 1));
      });
    },
    ...
    whichChild: function whichChild(el, parent) {
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].plugin(_alpinejs_focus__WEBPACK_IMPORTED_MODULE_3__["default"]); // Components

alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('header', _components_header_js__WEBPACK_IMPORTED_MODULE_4__["default"]);
